...
//		FachadaFazenda fachada = new FachadaFazenda(gadosRepLista, funcionariosRepLista, insumosRepLista, cultivosRepLista);
		...
		System.out.println("Gado de Corte - Gado de Reprodução - Funcionarios - Insumos - Cultivo");
		...
		boolean escolhacontinuar = false;
			...
			switch(escolha)
			{
				case "Gado de Corte":
				{
					...
					{
						System.out.println("Insira brinco, gênero, raça, vacina(sim / nao) e ano de nascimento respectivamente");
				...
				case "Funcionarios":
				{
					...
					escolha = in.next();
					if(escolha.equals("Inserir")) {
						System.out.println("Insira nome, contato, endereço, funçao e salário respectivamente");
				...
				case "Insumos":
				{
					...
					escolha = in.next();
					if(escolha.equals("Inserir")) {
						System.out.println("Informe item e quantidade para inserção");						
				...
				case "Cultivo":
				{
					...
					escolha = in.next();
					if(escolha.equals("Inserir")) {
						System.out.println("insira o  produto, quantidade, agrotoxico (Sim / Não), irrigação e colheita");
						...
						System.out.println("insira o  produto, quantidade, agrotoxico, irrigação e colheita");
						cultivos.setProduto(in.next());
						cultivos.setQuantidade(in.nextInt());
						String controlado = in.next();
						if(controlado.equals("Sim"))
